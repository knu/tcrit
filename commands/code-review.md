...
description: Review code changes in TCrit's multi-file TUI. Opens a tabbed interface showing all changed files with syntax highlighting and diff markers. After the review, address any comments.
